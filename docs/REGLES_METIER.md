...
- qualité de l'eau : ARS/SISE-Eaux via Hub'Eau, maintenue en diagnostic jusqu'à validation ;
...
`P301.3` n'est pas calculé lorsque `D302.0 < 100`. La ligne doit porter une valeur nulle, `NOT_CALCULABLE` et `NOT_APPLICABLE`.
